...
class PointEnv(Env):
    ...
    def __init__(self,
        ...
        self.max_step_size_per_dim = max_step_size_per_dim
    ...
    def step(self, action):
        self._state = self._state + self.max_step_size_per_dim * action
...
class SparsePointEnv(PointEnv):
    ...
    def __init__(self,
                 ...
                 on_circle_init_state=True,
                 **kwargs):
        super().__init__(max_episode_steps, n_tasks, **kwargs)
